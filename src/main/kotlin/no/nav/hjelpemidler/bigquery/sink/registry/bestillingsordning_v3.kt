...
val bestillingsordning_v3 = object : SchemaDefinition {
    ...
    override fun define(): TableDefinition = standardTableDefinition {
        schema {
            ...
            boolean("bruker_bor_ikke_pa_institusjon") {
            ...
            boolean("bruker_er_tilknyttet_hjmsentral_paa_pilot") {
                description("Bruker er tilknyttet en hjelpemiddelsentral som er på pilot for bestillingsordning")
            }
        }
